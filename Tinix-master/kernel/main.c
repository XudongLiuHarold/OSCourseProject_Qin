...
PUBLIC int tinix_main()
{
    ...
    disp_color_str("                   w                ",0x0E);disp_color_str("                                   \n",0x8B);
    disp_color_str("                 w * w              ",0x0E);disp_color_str("                                   \n",0x8B);
    disp_color_str("               w *    * w           ",0x0E);disp_color_str("         O         ooo             \n",0x8B);
    disp_color_str("           w w *        * w w       ",0x0E);disp_color_str("                 o^   ^o           \n",0x8B);
    disp_color_str("     w w w * *           * * w      ",0x0E);disp_color_str("                 o     o           \n",0x8B);
    disp_color_str("     w   *                   * w    ",0x0E);disp_color_str("            o     ^ooo^            \n",0x8B);
    disp_color_str("      w *                     * w   ",0x0E);disp_color_str("          o^ ^o                    \n",0x8B);
    disp_color_str("     w *     =           =     * w  ",0x0E);disp_color_str("           ^o^            O        \n",0x8B);
    disp_color_str("    w *     $Q$         $Q$     * w ",0x0E);disp_color_str("   O                               \n",0x8B);
    disp_color_str("  w *                           * w ",0x0E);disp_color_str("               ooo                 \n",0x8B);
    disp_color_str(" w *        ---------------     * w ",0x0E);disp_color_str("       o     o^   ^o               \n",0x8B);
    disp_color_str("    w *      \\V V V V V V/      * w",0x0E);disp_color_str("      o^ ^o   o     o              \n",0x8B);
    disp_color_str("      w *                       * w ",0x0E);disp_color_str("      ^o^     ^ooo^       O        \n",0x8B);
    disp_color_str("    w *        ---------       * w  ",0x0E);disp_color_str("                                   \n",0x8B);
    disp_color_str("  w *                         * w   ",0x0E);disp_color_str("            O                      \n",0x8B);
    disp_color_str("    w *                       * w   ",0x0E);disp_color_str("             Bruno && Teng && Henry\n",0x03);
    disp_color_str("====================================",0x04);disp_color_str("===================================\n",0x04);	TASK*		p_task;
